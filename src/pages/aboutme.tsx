          ...
          <div className="my-4 flex flex-wrap-reverse items-center justify-between gap-4 md:flex-nowrap">
            <div className="w-full space-y-6 text-justify">
              ...
              <p className="text-xs md:text-sm">
                ...
                stuff, playing games sometimes, visit cosplay event, photography
                (using my Sony a6000), do streaming in my Youtube channel, and
                watching animes. Oh by the way, if you don&apos;t mind, you can
                support me through Ko-fi or Trakteer to keep this site alive and
                maintained.
              </p>
