      ...
      <div className="flex flex-wrap-reverse items-center gap-4 md:flex-nowrap">
        <div className="block space-y-6 text-justify">
          <p>
            ...
            working in its ecosystem. To sharpen my understanding of something,
            I usually push myself to craft some projects and publish them here.
            Sometimes, I write some blogs to share my experience, testimonies,
            or tips & tricks as a frontend developer.
          </p>
          <p>
